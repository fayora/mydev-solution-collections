...
def import_cluster(vm_metadata, subnetId, cluster_image, machine_type, node_size, node_cores, slurm_version, lustreMGSIpAddress, installNextflow):
    ...
    cluster_files_download_url = "https://raw.githubusercontent.com/fayora/mydev-solution-collections/main/publish/SLURM_SecureVNet/"
    ...
    # We get the location from the VM metadata
    ...
    subnet_param = "SubnetId=" + subnetId
...
def main():
    ...
    parser.add_argument("--subnetId",
                        dest="subnetId",
                        help="Name of the subnet for the nodes")
    ...
    import_cluster(vm_metadata, args.subnetId, args.osOfClusterNodes, args.sizeOfWorkerNodes, args.numberOfWorkerNodes, args.countOfNodeCores, args.slurmVersion, lustre_mgs_ip_address, install_nextflow)

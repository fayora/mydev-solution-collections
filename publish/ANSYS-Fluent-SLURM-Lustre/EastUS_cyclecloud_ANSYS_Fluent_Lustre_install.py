...
def import_cluster(vm_metadata, cluster_image, machine_type, node_size, node_cores, slurm_version, lustreMGSIpAddress, installNextflow):
    ...
    cluster_parameters_file_name = "eastus_slurm_params.json"
    ...
    vnet_name = "eastus-ansys-license-server-vnet"
    subnet_name = "compute"
    ...
    subnet_string_value = vnet_resource_group + "/" + vnet_name + "/" + subnet_name

...
echo ""
# Intel 2018
IMPI_2018_VERSION="2018.4.274"
# !NOTE: CentOS 7.9 uses shm:ofa not shm:dapl
export INTELMPI_ROOT=/opt/intel/impi/$IMPI_2018_VERSION
export I_MPI_FABRICS=shm:ofa
export I_MPI_ROOT=/opt/intel/compilers_and_libraries/linux/mpi
source /opt/intel/impi/$IMPI_2018_VERSION/bin64/mpivars.sh
...
module load mpi/impi_$IMPI_2021_VERSION
source /opt/intel/oneapi/mpi/$IMPI_2021_VERSION/etc/conda/activate.d/mpivars.activate.sh

/opt/intel/oneapi/mpi/$IMPI_2021_VERSION/bin/mpirun IMB-MPI1 pingpong
